...
import hotels.comhomepage.HotelsHomePage;
...
public class HotelsHomePageTestDefinitions extends WebAPI {
    ...
    public void i_am_on_hotel_com_homepage() throws IOException {
